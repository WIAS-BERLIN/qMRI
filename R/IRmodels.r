...
IRmix2 <- function(par, InvTimes, S0f, T1f){
  ##
  ## Inversion Recovery MRI 2 compartments (fluid/solid) with fixed fluid parameters
  ##
  ## S_{InvTime} = S0f * abs( par[1] * (1-2*exp(-InvTime/T1f)) +
...
IRmix2fix <- function(par, InvTimes, T1f, T1s, S0f, S0s){
  ##
...
IRmix2QL <- function(par, InvTimes, S0f, T1f, CL, sig, L){
  ##
  ## Inversion Recovery MRI 2 compartments (fluid/solid) with fixed fluid parameters
  ##
  ## S_{InvTime} = S0f * abs( par[1] * (1-2*exp(-InvTime/T1f)) +
...
IRmix2fix <- function(par, InvTimes, T1f, T1s, S0f, S0s, CL, sig, L){
  ##
  ## Inversion Recovery MRI 2 compartments (fluid/solid) with fixed fluid and solid parameters
  ##              mixture parameter only
  ##
