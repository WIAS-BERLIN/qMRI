...
#               }
#               sres <- summary(res) 
#               thisEnv$isConv[x, y, z] <- res$convInfo$isConv
#               thisEnv$modelCoeff[, x, y, z] <- sres$coefficients[, 1]
#               if (sres$sigma != 0) {
#                 thisEnv$invCov[, , x, y, z] <- solve(sres$cov.unscaled) / sres$sigma^2
#               } else {
#                 ## TODO: CHECK!
#                 thisEnv$invCov[, , x, y, z] <- 0
#               }
#             }
#           }
#         }
...
# }
# 
# readMPMdataS4 <- function(t1Files  = NULL,
#                           pdFiles  = NULL,
#                           mtFiles  = NULL,
#                           maskFile = NULL,
#                           sdim     = NULL,
...
# }
# 
# estimateESTATICSS4 <- function(object,  ...) cat("No ESTATICS estimation defined for this class:", class(object), "\n")
# 
# setGeneric("estimateESTATICSS4", function(object,  ...) standardGeneric("estimateESTATICSS4"))
# 
# setMethod("estimateESTATICSS4", 
#           "mpmData",
#            function(object, 
#                     TEScale = 100,
#                     dataScale = 1000,
...
#                      if (object@model == 2) { 
#                        ## full ESTATICS model
#                        cat("found model 2 in", x, y, z, "\n")
#                        cat("                ", indT1, indMT, indPD, R2star, "\n")
#                        th <- c(ivec[indT1] * exp(-xmat[indT1, 4] * R2star), # par[1]
#                                ivec[indMT] * exp(-xmat[indMT, 4] * R2star), # par[2]
#                                ivec[indPD] * exp(-xmat[indPD, 4] * R2star), # par[3]
#                                R2star)                                      # par[4]
...
#            })
# 
# smoothESTATICSS4 <- function(object,  ...) cat("No ESTATICS smoothing defined for this class:", class(object), "\n")
# 
# setGeneric("smoothESTATICSS4", function(object,  ...) standardGeneric("smoothESTATICSS4"))
# 
# setMethod("smoothESTATICSS4", 
#           "ESTATICSModel",
#           function(object, 
#                    mpmData = NULL,
