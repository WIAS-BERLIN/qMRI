...
C
C  fval = th(1) * abs( 1 - 2*exp(-invtime/th2)
C
      implicit logical (a-z)
      integer n
      double precision th(2),invtime(n),fval(n),grad(n,2)
      integer i
      double precision z1,z2,fv,th1,th2,thq
      th1=th(1)
      th2=th(2)
      thq=th1/th2/th2
      DO i=1,n
         ...
         fval(i)=th1*abs(z2)
         grad(i,1)=abs(z2)
         grad(i,2)=-dsign(2.d0*thq*z1*invtime(i),z2)
      END DO
      RETURN
      END
...
C
      ...
      integer i
      double precision z1,z2,z3,th1,th2,th3,th13,thq
      th1=th(1)
      th2=th(2)
      th3=th(3)
      th13=th3*(1.d0-th1)
      ...
      DO i=1,n
         ...
         grad(i,2)=-dsign(th13*2.d0*thq*z2*invtime(i),th1*z1+th13*z3)
...
C
      ...
      integer i
      double precision z1,z2,z3,th13,thq
      th13=th3*(1.d0-th1)
      thq=th13/th2/th2
      DO i=1,n
